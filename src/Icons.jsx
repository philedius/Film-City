...
function Plus() {
    return (
        <div className="icon plus-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="75%" height="75%"><path className="heroicon-ui" d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm1-9h2a1 1 0 0 1 0 2h-2v2a1 1 0 0 1-2 0v-2H9a1 1 0 0 1 0-2h2V9a1 1 0 0 1 2 0v2z"/></svg>
        </div>
    );
};
...
function Minus() {
    return (
        <div className="icon minus-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="75%" height="75%"><path className="heroicon-ui" d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm4-8a1 1 0 0 1-1 1H9a1 1 0 0 1 0-2h6a1 1 0 0 1 1 1z"/></svg>
        </div>
    );
};
...
function Info() {
    return (
        <div className="icon info-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="75%" height="75%"><path className="heroicon-ui" d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0-9a1 1 0 0 1 1 1v4a1 1 0 0 1-2 0v-4a1 1 0 0 1 1-1zm0-4a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/></svg>
        </div>
    );
};

export { Plus, Minus, XSymbol, View, Star, Info };